...
export EXP_NAME="movie_reproduce_exp_50_unsupervised"

# CUDA device to use (-1 to use CPU, change to use a different GPU)
export CUDA_DEVICE=1

# output file to save to
export OUTPUT_FILENAME="output_unsupervised_50e.txt"
...
dataset_folder=data/movies \
	...
	batch_size=4 \
	rs_weight=0 \
	bash Rationale_model/commands/model_train_script.sh > $OUTPUT_FILENAME
